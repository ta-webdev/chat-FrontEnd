    ...
    return(
        <div className={`ThankYou ${eventStyling}`} style={ eventTemplate && {backgroundImage : `url(${eventTemplate.bg})`}}>
            ...
            <div className="content-holder w-100 d-flex justify-content-around align-items-center flex-column">
                ...
                { eventTemplate && eventTemplate.thankYou.footerImg.length > 0 && <div className="footer-img-holder position-absolute w-100 d-flex align-items-center justify-content-center">
                    <Image src={eventTemplate.thankYou.footerImg} cls={"footer-image"}/>
                </div> }
            </div>
        </div>
    )
